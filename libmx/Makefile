...
SRC		=	mx_printchar.c mx_print_unicode.c mx_printstr.c mx_print_strarr.c mx_printint.c mx_pow.c mx_sqrt.c \
			...
			mx_atoi.c mx_isspace.c mx_isdigit.c mx_isalpha.c mx_strchr.c mx_strncmp.c mx_strnlen.c mx_filelen.c mx_printlist.c mx_printerr.c
...
testlib: 
	@clang -std=c11 -Wall -Wextra -Werror -Wpedantic -fsanitize=address -g test/test.c libmx.a
	@mv a.out test/a.out
	@./test/a.out
	@rm -rf test/a.out
	@rm -rf a.out.dSYM
